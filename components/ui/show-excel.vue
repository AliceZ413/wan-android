<template>
	<div id="show-excel-comp">
		...
		<div class="menu">
			<img @click="hideExcel" src="@/../resource/images/excel/icon_return.png" alt="">
			<img @click="scaleD" src="@/../resource/images/excel/icon_scale-d.png" alt="">
			<img @click="scaleX" src="@/../resource/images/excel/icon_scale-x.png" alt="">
